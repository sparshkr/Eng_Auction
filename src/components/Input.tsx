  ...
  return (
    <div className="relative w-[120%] mu:w-[140%] max-w-[600px] h-[42px] m-0 p-0 mu:h-[3.6rem]">
      <input
        ...
        className="w-full h-full border-t-0 border-b-0 rounded-t-[30px] rounded-b-[60px] p-2 bg-transparent text-center text-white placeholder:text-[15px] placeholder:font-[300] placeholder-white placeholder:pr-8 focus:outline-none relative z-10"
      />
