...
export default function InputComponent({ value, onChange, placeholder }: InputProps) {
  return (
    <div className="relative w-[110%]   mu:w-[140%] ms:w-[130%] max-w-[600px] h-[42px] m-0 p-0 ms:h-[3.2rem] mu:h-[3.6rem]">
      <input
        type="number"
