...
export default function Card({
  ...
  return (
    <div className="relative w-[80%] msx:w-[82%] msx:h-[18em] h-[12.5em] rounded-[50px] mu:rounded-[75px] p-[2px] bg-gradient-to-r from-blue-500 to-red-600 shadow-custom2 mu:h-[20em] mu:w-[80%]">
      ...
      <div className="absolute -bottom-9 md:left-1 flex flex-col text-[11px] justify-center items-center gap-0 mu:text-[15px] mu:relative mu:right-[5.3rem] ms:right-[4.9rem] ms:top-[0.7rem] mu:top-[1rem] ms:text-[13px] font-manrope ">
        <div className="-mb-1 ">EMD Paid</div>
        <div>${EMDprice.toFixed(2)}</div>
      </div>
      <div className="absolute  -bottom-9 flex flex-col text-[11px] justify-center items-center gap-0 mu:text-[15px] mu:relative mu:left-[6.2rem] ms:left-[5.5rem] mu:top-[-1.7rem] md:-right-2 ms:text-[13px] ms:top-[-1.5rem] font-manrope ">
