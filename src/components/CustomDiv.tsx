...
export default function CustomDiv({ children }: CustomDivProps) {
  return (
    <div className="relative inline-block h-full w-full">
      ...
      {/* Content */}
      <div className="relative z-10 w-full h-full px-6 py-[0.25rem] bg-transparent text-white rounded-lg shadow-[0_5px_50px_-12px_rgba(255,253,0,0.5)] text-[0.5rem] mu:text-[0.7rem] bg-white bg-opacity-15">
        {children}
      </div>
    </div>
  );
